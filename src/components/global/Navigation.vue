        ...
        <div v-else>
            <div class="dropdown">
                ...
                <div class="dropdown-menu shadow">
                    <div>
                        <router-link class="dropdown-item" :to="{name: 'editProfile', params: {nameId: user.nameId}}">
                            {{ $t('editProfile') }}
                        </router-link>
                    </div>
                    <div>
                        <router-link class="dropdown-item" :to="{name: 'publicHome', params: {nameId: user.nameId}}">
                            {{ $t('viewPublicHome') }}
                        </router-link>
                    </div>
